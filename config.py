...
class Config(object):
    ...
    BLOB_CONNECTION_STRING = os.environ.get('BLOB_CONNECTION_STRING') or 'ENTER_BLOB_CONNECTION_STRING'
    ...
    REDIRECT_PATH = "https://udacitycms-efdqgcf7duafekay.swedencentral-01.azurewebsites.net/getAToken"  # Used to form an absolute URL; must match to app's redirect_uri set in AAD
